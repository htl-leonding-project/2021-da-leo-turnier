...
Die Methode wird dann nur zur Initialisierung der Component aufgerufen, wie uns der Name schon verrät. Somit wird sofort nach dem Konstruktor die Methode aufgerufen. Dabei können Daten können schon vor dem Start der Component beschaffen werden und danach vielleicht Tabelle befüllt werden. 

\bigskip
\begin{figure}[H]
    \includegraphics[scale=1]{pics/frontend/example_ngOnInit.PNG}
