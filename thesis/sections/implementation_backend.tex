...
\begin{figure}[H]
    \includegraphics[scale=0.25]{pics/backend/elimination_tree_seeded_wrong_big.png}
...
\begin{figure}[H]
    \includegraphics[scale=0.5]{pics/backend/elimination_orderSeededCompetitors.png}
...
\begin{figure}[H]
    \includegraphics[scale=0.8]{pics/backend/seeding_1.png}
    \caption{Anordnen der Teilnehmer 1}
    \includegraphics[scale=0.8]{pics/backend/seeding_2.png}
    \caption{Anordnen der Teilnehmer 2}
    \includegraphics[scale=0.8]{pics/backend/seeding_3.png}
...
\begin{figure}[H]
    \includegraphics[scale=0.25]{pics/backend/elimination_tree_seeded_big.png}
    \caption{großer Turnierbaum geseedet\cite{implementation-elimination-1}}
\end{figure}
